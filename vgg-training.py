...
# Download the vgg16_bn file into the directory from the link: https://download.pytorch.org/models/vgg16_bn-6c64b313.pth
...
vgg16.load_state_dict(torch.load("./weights/vgg16_bn-6c64b313.pth"))
...
if resume_training:
    ...
    vgg16.load_state_dict(torch.load('../weights/vgg16_v1-flower-or-crops.pt'))
    print("Loaded!")
...
torch.save(vgg16.state_dict(), 'weights/vgg16_v1-flower-or-crops.pt')
